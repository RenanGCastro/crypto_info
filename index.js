...
const func_info = async (cryptos, tempo) => {
    ...
    let mensagem = 'Tempo Gráfico de '+texto_tempo+'\n\n'
...
var job_4_hora = new CronJob('0 0 */4 * * *', function() {
    console.log('Rodou cron de 4 hora');
    func_info(cryptos_1, '4h')
    func_info(cryptos_2, '4h')
    func_info(cryptos_3, '4h')
    func_info(cryptos_4, '4h')
}, null, true, 'America/Los_Angeles');
job_4_hora.start();
